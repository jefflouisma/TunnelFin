...
public class ScraperNyaaTests
{
    private readonly Mock<ILogger<ScraperNyaa>> _mockLogger;

    public ScraperNyaaTests()
    {
        _mockLogger = new Mock<ILogger<ScraperNyaa>>();
    }
...
<table class=""torrent-list"">
  <tbody>
        ...
        var scraper = new ScraperNyaa(httpClient, _mockLogger.Object);
...
<table class=""torrent-list"">
  <tbody>
        ...
        // Act
        var results = await scraper.SearchAsync("NonExistentAnime", CancellationToken.None);
